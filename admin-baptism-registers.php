 ...
 */
class Placita_List_Table extends WP_List_Table {
...
//            'delete'    => 'Delete'
    ...
    function prepare_items() {
        ...
        foreach ( $pdfs as $pdf ) {
            $filename = $pdf;
            $pdf = str_replace('Baptism_Preregister_', '', $pdf);
            $pdf = str_replace('.pdf', '', $pdf);
            
            $pdf_data = explode('_', $pdf);
            
            $child_name = $pdf_data[0] . ' ' . $pdf_data[1];
            
            $date = date_create_from_format('Y-m-d H:i:s', $pdf_data[2]);
